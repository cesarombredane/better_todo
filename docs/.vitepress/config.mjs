...
const repositoryUrl = 'https://github.com/cesarombredane/better_todo'
const sourceRoutes = {
  'README.md': 'index.md',
...
const config = withMermaid(defineConfig({
  title: 'Better Todo',
  description: 'Application documentation and contributor guides for Better Todo.',
  lang: 'en-US',
  appearance: 'force-dark',
  srcExclude: ['**/node_modules/**'],
  rewrites: { 'README.md': 'website.md' },
  themeConfig: {
    siteTitle: 'BETTER TODO',
    nav: [
      { text: 'Overview', link: '/' },
    ...
    footer: { message: 'Better Todo · Private Android task organizer' },
  },
  markdown: {
    config(md) {
